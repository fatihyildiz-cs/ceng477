...
//float intersectTriangle(const Ray &ray, Triangle &triangle, vector<Vec3f> &vertices,int rayOrder)
//{
...
//    Vec3f normalHelper;
//    float determinantA = determinant(index1 - index2, index1 - index3, ray.d);
//    float b = determinant(index1 - ray.o, index1 - index3, ray.d) / determinantA;
//    float g = determinant(index1 - index2, index1 - ray.o, ray.d) / determinantA;
//    float t = determinant(index1 - index2, index1 - index3, index1 - ray.o) / determinantA;
    ...
    for(parser::Camera camera : my_cameras ) {
        ...
        for (int y = 0; y < height; ++y) {
            for (int x = 0; x < width; ++x) {
                ...
                if (myColor.r >0 || myColor.b > 0 || myColor.g >0) {
                    image[i++] = myColor.r;
                    image[i++] = myColor.g;
                    image[i++] = myColor.b;
